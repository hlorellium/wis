...
describe('BackgroundRenderer', () => {
  ...
  describe('render', () => {
    it('should clear the canvas and draw grid lines', () => {
      ...
      const beginPathCall = mockCtx.calls.find(call => call.method === 'beginPath');
    ...
    it('should apply view transformations', () => {
      ...
      const translateCall = mockCtx.calls.find(call => call.method === 'translate');
    ...
    it('should draw both vertical and horizontal grid lines', () => {
      ...
      const moveToCall = mockCtx.calls.filter(call => call.method === 'moveTo');
      const lineToCall = mockCtx.calls.filter(call => call.method === 'lineTo');
